...
var appName = "demo";
var url = 'https://api.masterdatanode.com/' + appName + '/taskmanager/';
...
//                count++;
                if (type == "started") {
                    $('#newList').append('<a href="#finish" class="" id="item"><li id="' + identifier + '" class="list-group-item">' + todo + '<span class="arrow pull-right"><i class="glyphicon glyphicon-arrow-right"></span></li></a>');
                } else if (type == "inProgress") {
                    $('#currentList').append('<a href="#finish" class="" id="inProgress"><li id="' + identifier + '" class="list-group-item">' + todo + '<span class="arrow pull-right"><i class="glyphicon glyphicon-arrow-right"></span></li></a>');
                } else {
                    $('#archivedList').append('<a href="#finish" class="" id="archived"><li id="' + identifier + '" class="list-group-item">' + todo + '<span class="arrow pull-right"><i class="glyphicon glyphicon-remove"></i></span></li></a>');
                }
